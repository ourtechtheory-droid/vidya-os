...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB]" data-testid="dashboard-layout">
      {/* Glass top bar */}
        ...
        <div className="px-4 md:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Link to="/app" className="flex items-center gap-2" data-testid="dashboard-brand">
              <div className="w-8 h-8 rounded-lg bg-[#E05236] grid place-items-center text-white font-display font-bold text-sm">Vi</div>
              <div className="font-display text-lg font-semibold tracking-tight hidden sm:block">Vidya<span className="text-[#E05236]">OS</span></div>
            </Link>
          ...
          <div className="flex items-center gap-2">
            <button className="p-2 rounded-lg hover:bg-black/5 relative" aria-label="notifications" data-testid="notifications-button">
              ...
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#E05236] rounded-full" />
            </button>
