    ...
    <div className="space-y-6" data-testid="ai-insights-page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="card-soft p-6 lg:col-span-2 min-h-[300px]">
          <div className="flex items-center gap-2 text-[#E05236]"><Brain className="w-5 h-5" /><div className="font-display text-lg font-semibold text-[#0A1128]">Today's brief</div></div>
          <div className="mt-4">
        ...
        <div className="card-soft p-6 !bg-[#0A1128] text-white relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <ul className="mt-4 space-y-3 text-sm text-white/80">
              <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#E05236] mt-2" /> Attendance dips in Class 9-A</li>
              <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#E05236] mt-2" /> Pending fees concentration</li>
              <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#E05236] mt-2" /> Subject weakness clusters</li>
              <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#E05236] mt-2" /> Teacher workload anomalies</li>
            </ul>
          </div>
        </div>
      </div>
