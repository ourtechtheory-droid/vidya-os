...
function StatusBadge({ status }) {
  ...
  const styles = {
    approved: "bg-[#E6F8F3] text-[#3a6a4a]",
    ...
    <div className="space-y-6" data-testid="id-cards-page">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="card-soft p-6 space-y-4">
          <div className="flex items-center gap-2">
            <IdCard className="w-5 h-5 text-[#FF5E3A]" />
          ...
          <div className="rounded-xl bg-[#E6F8F3] p-4 text-sm text-[#10B981]">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
          {batches.map((b) => (
            <button
              ...
              className="text-left rounded-xl border border-black/5 bg-white p-4 hover:border-[#FF5E3A]/50 hover:shadow-sm transition"
            >
              <div className="flex items-start justify-between">
      ...
      <div className="card-soft p-6">
        <div className="flex items-center gap-2">
          <RefreshCw className="w-4 h-4 text-[#FF5E3A]" />
                      ...
                      >
                        ...
                        {pendingReissue ? (
                          ...
                          <button
                            ...
                            className="text-xs text-neutral-600 hover:text-[#FF5E3A]"
                          >
                            Mark for reissue
                          </button>
                        )}
