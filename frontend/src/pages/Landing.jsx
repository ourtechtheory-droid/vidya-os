...
export default function Landing() {
  return (
    <div className="min-h-screen !bg-background text-[#0A1128]" data-testid="landing-page">
      {/* GLASS NAV */}
      <header className="sticky top-0 z-50 glass" data-testid="landing-header">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 lg:px-12 py-4">
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="hidden sm:inline text-sm font-medium hover:text-[#FF5E3A]" data-testid="nav-signin">Sign in</Link>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <FadeUp className="col-span-12 lg:col-span-7">
            <div className="card-soft p-10 md:p-14 relative overflow-hidden">
              <div className="absolute -right-10 -top-10 w-72 h-72 bg-gradient-to-br from-[#FF5E3A]/20 via-[#10B981]/15 to-[#0A1128]/5 rounded-full blur-3xl opacity-80" />
              <div className="relative">
                ...
                <h1 className="mt-6 font-display text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.05] text-balance">
                  The operating system for <span className="text-[#FF5E3A]">21<sup className="text-2xl">st</sup>-century</span> schools.
                </h1>
          ...
          {[
            ...
            { k: "8.4×", v: "Faster parent-school response time", c: "!bg-[#FFF3F0]", plain: true },
        ...
        <div className="grid grid-cols-12 gap-6">
          <FadeUp className="col-span-12 lg:col-span-5">
            <div className="card-soft p-8 lg:p-10 h-full !bg-[#0A1128] text-white relative overflow-hidden">
              <div className="absolute -bottom-20 -left-20 w-72 h-72 bg-[#FF5E3A]/30 rounded-full blur-3xl" />
              <div className="relative">
                ...
                <ul className="mt-6 space-y-4 text-white/80 text-sm">
                  <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#FF5E3A] mt-2" /> Detect dropout & stress risk before it happens</li>
                  <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#FF5E3A] mt-2" /> Auto-generate report card comments per student</li>
                  <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#FF5E3A] mt-2" /> Parent chatbot answers in 8 Indian languages</li>
                  <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#FF5E3A] mt-2" /> Principal's daily intelligence brief, on autopilot</li>
                </ul>
              </div>
            </div>
          </FadeUp>
          ...
          <FadeUp delay={100} className="col-span-12 lg:col-span-7 grid grid-cols-2 gap-6">
            ...
            <div className="card-soft p-6 !bg-[#E6F8F3]">
              <BookOpen className="w-8 h-8 text-[#10B981]" strokeWidth={1.5} />
            ...
            <div className="card-soft p-6">
              <FileText className="w-8 h-8 text-[#FF5E3A]" strokeWidth={1.5} />
      ...
      <section id="boards" className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <div className="grid grid-cols-12 gap-6">
          ...
          <FadeUp delay={100} className="col-span-12 md:col-span-5 grid gap-6">
            <div className="card-soft p-8 !bg-[#FFF3F0]">
