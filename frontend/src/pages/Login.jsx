...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-[#F9FAFB]" data-testid="login-page">
      {/* Left side: form */}
          ...
          <form onSubmit={submit} className="mt-8 space-y-4" data-testid="login-form">
            <div>
              ...
              <input
                ...
                className="mt-2 w-full px-4 py-3 rounded-xl border border-black/10 bg-white focus:outline-none focus:ring-2 focus:ring-[#E05236]/30 focus:border-[#E05236] transition"
            ...
            <div>
              ...
              <div className="mt-2 relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 rounded-xl border border-black/10 bg-white focus:outline-none focus:ring-2 focus:ring-[#E05236]/30 focus:border-[#E05236] transition"
            ...
            <div className="mt-3 grid gap-2">
              {DEMO.map((d) => (
                <button key={d.email} onClick={() => quickFill(d)}
                  className="text-left px-4 py-3 rounded-xl border border-black/5 bg-white hover:border-[#E05236] hover:shadow-sm transition flex items-center justify-between"
                  ...
                  <span className="text-xs text-[#E05236] font-medium">Use →</span>
                </button>
              ))}
            </div>
      ...
      <div className="hidden lg:flex items-center justify-center p-12 relative bg-[#0A1128] text-white overflow-hidden">
        ...
        <div className="absolute -top-32 -right-32 w-[480px] h-[480px] bg-[#E05236]/30 rounded-full blur-3xl" />
        <div className="absolute -bottom-32 -left-32 w-[480px] h-[480px] bg-[#4A7C59]/20 rounded-full blur-3xl" />
