          ...
          <div className="xl:col-span-2 card-soft p-6">
            ...
            <div className="mt-4">
              {currentTemplate ? (
                ...
                <div className="text-sm text-neutral-500 p-8 rounded-lg border border-dashed border-black/10">
                  Pick a template from the dropdown to preview.
                </div>
              )}
            </div>
          </div>
                  ...
                  <tr key={iss.id} className="border-b border-black/5">
                    ...
                    <td className="py-2 pr-3">
                      {iss.status === "revoked" ? (
                        ...
                        <span className="text-[10px] font-medium px-2 py-0.5 rounded-full bg-[#E5EFE8] text-[#3a6a4a]">
                    ...
                    <td className="py-2 pr-3 text-right">
                      <button
                        ...
                        className="text-xs text-neutral-600 hover:text-[#E05236] inline-flex items-center gap-1 mr-2"
                      >
